...
public final class SelectionPredicates {
     ...
     * @return
     */
    public static @NonNull <K> SelectionTracker.SelectionPredicate<K> createSelectAnything() {
     ...
     * @return
     */
    public static @NonNull <K> SelectionTracker.SelectionPredicate<K> createSelectSingleAnything() {
        return new SelectionTracker.SelectionPredicate<K>() {
            @Override
            public boolean canSetStateForKey(@NonNull K key, boolean nextState) {
                return true;
