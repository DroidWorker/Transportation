 ...
 * <p>
 * See
 * {@link SelectionTracker.Builder SelectionTracker.Builder}
...
public abstract class StorageStrategy<K> {
    ...
    @VisibleForTesting
    static final String SELECTION_ENTRIES = "entries";

    @VisibleForTesting
    static final String SELECTION_KEY_TYPE = "type";
    ...
    Selection<K> asSelection(@NonNull Bundle state);
    ...
    private static class StringStorageStrategy extends StorageStrategy<String> {
        ...
        @Override
        public @Nullable
        Selection<String> asSelection(@NonNull Bundle state) {
    ...
    private static class LongStorageStrategy extends StorageStrategy<Long> {
        ...
        @Override
        public @Nullable
        Selection<Long> asSelection(@NonNull Bundle state) {
            String keyType = state.getString(SELECTION_KEY_TYPE, null);
            if (keyType == null || !keyType.equals(getKeyTypeName())) {
                return null;
            }
