...
class Repository(private val dao: MainDao) : KoinComponent {
    ...
    suspend fun resetOrderCountNews(id: String): InfoMessageResponse = kotlin.runCatching {
        ...
        kotlin.runCatching {
            InfoMessageResponse(responseBody)
        }.getOrElse {
                InfoMessageResponse(responseBody)
        }
    }.getOrElse {
    ...
    suspend fun getAdvertFavoriteList(): AdvertFavResponse = kotlin.runCatching {
        ...
        kotlin.runCatching {
            ...
            if (responseBody.contains("header")) authToken = null
    ...
    suspend fun getOrderFavoriteList(): OrderFavResponse = kotlin.runCatching {
        ...
        kotlin.runCatching {
            ...
            else if (responseBody.contains("header")) {
                authToken = null
        ...
        else if (it.stackTraceToString().contains("header")) {
            authToken = null
